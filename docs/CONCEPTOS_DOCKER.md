...
flowchart LR
    ...
    NAV -.->|"opcional (diagnóstico):<br/>localhost:15449"| POSTGRES
    NAV -.->|"opcional (diagnóstico):<br/>localhost:11448"| SQLSERVER
    NAV -.->|"opcional (diagnóstico):<br/>localhost:13348"| MARIADB
```
