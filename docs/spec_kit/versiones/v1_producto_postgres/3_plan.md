...
└── api_facturas/
    ...
    ├── Dockerfile                    # sdk:10.0 + dotnet watch (puerto 8056)
    ├── Modelos/
...
funcionando. En v1 eso son **dos servicios**: `postgres` (15449 al host,
se siembra solo) y `api-facturas` (8056, código montado +
