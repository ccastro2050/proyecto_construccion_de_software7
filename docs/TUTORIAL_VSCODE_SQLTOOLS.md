...
> [README](../README.md)). PostgreSQL queda publicado en `localhost:15449`.
...
| Port | `15449` | El puerto del host del compose (`15449:1433`) |
...
> El puerto es la clave: **15449, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 15449
...
>
> ```
> Error opening connection Failed to connect to localhost:15449
...
> (`http://localhost:8056/api/producto/PR009`) — un solo dato, muchos
> clientes.
...
| 1 | Crear la conexión (localhost:15449) con test y guardarla |
