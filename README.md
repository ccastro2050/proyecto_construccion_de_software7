...
> el puerto 8056 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                               STATUS                    PORTS
> proyecto_construccion_de_software7-api-facturas-1   Up 2 hours                0.0.0.0:8056->8056/tcp
> proyecto_construccion_de_software7-postgres-1       Up 2 hours (healthy)      0.0.0.0:15449->5432/tcp
> ```
>
...
```powershell
git clone https://github.com/ccastro2050/proyecto_construccion_de_software7.git
cd proyecto_construccion_de_software7
...
| MariaDB (opcional — v5) | `localhost:13348` · `root`/`Construccion123!` |
...
> ℹ️ Este proyecto usa los puertos 8056 y 15449: si alguno ya está ocupado
...
```
proyecto_construccion_de_software7/
...
│
├── api_facturas/                # LA API DE LA v1 — C#/ASP.NET Core (puerto 8056)
...
│   ├── appsettings.json         # Cadena de conexión (default localhost:15449)
